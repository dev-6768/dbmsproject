...
class ProductFetch {
  ...
  ProductFetch({this.uid, this.category, this.name, this.shortDesc, this.longDesc, this.price, this.quantity, this.image1, this.image2, this.image3, this.image4});
}
